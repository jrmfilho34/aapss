...
<pagina-component tamanho="12">
        ...
        @endif
    <painel-component titulo="Lista de Autores" cor="danger">
...
<modal-component nome="adicionar" titulo="Adicionar">
        ...
        <formulario-component id="formAdicionar" css="" rota="{{ route('autores.store')}}" method="post" token="{{ csrf_token() }}">
...
<modal-component nome="editar" titulo="Editar">
        <formulario-component id="formEditar" css="" v-bind:rota="'/autores/' + $store.state.item.id " method="put" token="{{ csrf_token() }}">
            <div class="form-group">
                <label for="name">Nome</label>
